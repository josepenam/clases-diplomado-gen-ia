...
| **5.3 — Imágenes** | Detección local (YOLO), entendimiento multimodal, generación (gpt-image-1) y OCR semántico | [carpeta](class_5_3_imagenes/README.md) · [diapositivas](class_5_3_imagenes/deck/deck_5_3_imagenes.pptx) |
...
3. **[Lección 3 · Generación de imágenes](class_5_3_imagenes/leccion3_generacion_imagenes/)** — GPT-5 orquesta `gpt-image-1` vía la Responses API (`bind_tools`); la imagen vuelve en base64 y queda en `outputs/`.
